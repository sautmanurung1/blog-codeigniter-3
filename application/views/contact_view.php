			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-4">
					...
					<ul class="font-11 list-relative list-li-pl-30 list-block list-li-mb-15">
						<li><i class="abs-tl ion-ios-location"></i>Jl. Ilyas Yakub 09 <br/>81237. Indonesia</li>
						<li><i class="abs-tl ion-android-mail"></i>Info@gmail.com</li>
						<li><i class="abs-tl ion-android-call"></i>(+12)-345-321-201</li>
					</ul>
